...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2JvZHkvaXRlbS12aWV3L2l0ZW0tdmlldy5jb21wb25lbnQuY3NzIn0= */"
...
module.exports = "<div class=\"container\">\n\n  <div class=\"\">\n    <img src=\"/assets/singer.png\" class=\"img-fluid\">\n  </div>\n\n</div>"
...
var baseUrl = "http://localhost:8085/spotify";
var songs = "/songs";
var song = "/song";
var songById = "/song/***";
var urls = /** @class */ (function () {
    ...
    urls.createUrlQuery = function (queryParam) {
        ...
        for (var _i = 0, _a = Object.keys(queryParam); _i < _a.length; _i++) {
            var param = _a[_i];
            params = params.concat(param + "=" + queryParam[param] + "&");
        }
        params = params.slice(0, params.length - 1);
        return baseUrl.concat(songs + params);
    };
    urls.createUrlPathVariable = function (path) {
        return baseUrl.concat(songById).replace("***", path);
    };
    return urls;
}());
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(songService) {
        this.songService = songService;
        this.name = "";
        this.artist = "";
        this.top = 50;
...
module.exports = __webpack_require__(/*! /home/global/work/workspaces/defualt-workspace/spotify-frontend/spotify/src/main.ts */"./src/main.ts");
